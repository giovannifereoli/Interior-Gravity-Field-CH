...
# Load the OBJ file
mesh = trimesh.load("3dmeshes/Eros_50k.obj")
mesh = trimesh.load("3dmeshes/Eros_12k.obj")
...
# 1) No rotation
CYLINDER_CENTER = np.array([0.0, 0.0, 0.2])  # Center of the cylinder base in XYZ
CYLINDER_HEIGHT = 0.5  # Height of the cylinder in meters
CYLINDER_RADIUS = 0.05  # Radius of the cylinder in meters
