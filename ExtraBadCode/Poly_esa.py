...
mesh_plotting.plot_grid_2d(
    ...
    Y,
    potentials,
    "Potential of Eros XY-Plane ($z=0$)",
    "eros_potential_2d_xy.png",
    vertices=vertices,
    coordinate=2,
)
mesh_plotting.plot_grid_3d(
    X,
    Y,
    potentials,
    "Potential of Eros XY-Plane ($z=0$)",
    "eros_potential_3d_xy.png",
)
...
mesh_plotting.plot_quiver(
    ...
    Y,
    acc_xy,
    "Acceleration in $x$ and $y$ direction for $z=0$",
    "eros_field_xy.png",
    vertices=vertices,
    coordinate=2,
)
...
mesh_plotting.plot_grid_2d(
    ...
    Z,
    potentials,
    "Potential of Eros XZ-Plane ($y=0$)",
    "eros_potential_2d_xz.png",
    labels=("$x$", "$z$"),
    vertices=vertices,
    coordinate=1,
)
...
mesh_plotting.plot_quiver(
    ...
    Z,
    acc_xy,
    "Acceleration in $x$ and $z$ direction for $y=0$",
    "eros_field_xz.png",
    labels=("$x$", "$z$"),
    vertices=vertices,
    coordinate=1,
...
mesh_plotting.plot_grid_2d(
    ...
    Z,
    potentials,
    "Potential of Eros YZ-Plane ($x=0$)",
    "eros_potential_2d_yz.png",
    labels=("$y$", "$z$"),
    vertices=vertices,
    coordinate=0,
)
...
mesh_plotting.plot_quiver(
    ...
    Z,
    acc_xy,
    "Acceleration in $y$ and $z$ direction for $x=0$",
    "eros_field_yz.png",
    labels=("$y$", "$z$"),
    vertices=vertices,
    coordinate=0,
